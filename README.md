...
We use `changesets` package to maintain changelog and publish `telescope` and `waterfall` packages to NPM registry. See [.changeset/README.md](.changeset/README.md) for instructions on how to use it.
